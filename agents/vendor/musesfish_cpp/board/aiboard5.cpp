...
int musesfish_query_min_depth = 5;
int musesfish_query_max_depth = 6;
...
std::string mtd_thinker5(board::AIBoard5* bp){
    ...
    int max_depth = std::min((bp -> round < 15?6:7), musesfish_query_max_depth);
    int min_depth = std::min(musesfish_query_min_depth, max_depth);
